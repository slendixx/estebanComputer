...
execute at 0-2-0-0-5 if block ~ ~-1 ~ minecraft:gray_wool run execute at 0-1-2-5-3 run setblock ~ ~-1 ~ minecraft:stone destroy
execute at 0-2-0-0-5 if block ~ ~-1 ~ minecraft:gray_wool run execute at 0-1-2-5-4 run setblock ~ ~-1 ~ minecraft:redstone_block destroy
