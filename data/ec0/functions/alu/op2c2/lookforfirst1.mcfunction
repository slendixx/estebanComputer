...
execute at 0-2-0-0-0 if block ~ ~-1 ~1 white_wool run execute at 0-2-0-11-0 run setblock ~ ~-1 ~ stone destroy
execute at 0-2-0-0-0 if block ~ ~-1 ~1 white_wool run execute at 0-2-0-11-1 run setblock ~ ~-1 ~ redstone_block destroy
