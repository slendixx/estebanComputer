...
execute at 0-2-0-0-0 if block ~ ~-1 ~ minecraft:gray_wool run execute at 0-2-0-2-2 run setblock ~ ~-1 ~ minecraft:stone destroy
execute at 0-2-0-0-0 if block ~ ~-1 ~ minecraft:gray_wool run execute at 0-2-0-2-3 run setblock ~ ~-1 ~ minecraft:redstone_block destroy
