...
execute at 0-2-0-0-0 if block ~ ~-1 ~ minecraft:white_wool run execute at 0-2-0-0-0 if block ~ ~-1 ~1 minecraft:black_wool run execute at 0-2-0-0-0 run setblock ~ ~-1 ~3 minecraft:white_wool destroy

execute at 0-2-0-0-0 if block ~ ~-1 ~ minecraft:black_wool run execute at 0-2-0-0-0 if block ~ ~-1 ~1 minecraft:white_wool run execute at 0-2-0-0-0 run setblock ~ ~-1 ~3 minecraft:white_wool destroy
...
execute at 0-2-0-0-0 if block ~ ~-1 ~ minecraft:gray_wool run execute at 0-2-0-8-0 run setblock ~ ~-1 ~ minecraft:stone destroy
